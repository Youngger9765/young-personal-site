...
export default function ProjectsGalleryPage() {
  ...
  const projects: ProjectCardData[] = [
    {
      slug: 'med-vision',
      title: t('medVision.title'),
      subtitle: t('medVision.subtitle'),
      description: t('medVision.description'),
    },
    {
      slug: 'xian',
      title: t('xian.title'),
      subtitle: t('xian.subtitle'),
      description: t('xian.description'),
    },
    {
      slug: 'career-creator',
      title: t('careerCreator.title'),
      subtitle: t('careerCreator.subtitle'),
      description: t('careerCreator.description'),
    },
{
      slug: 'jutor',
      title: t('jutor.title'),

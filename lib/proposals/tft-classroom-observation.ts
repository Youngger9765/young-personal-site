...
220 萬從零打造專屬系統；20 萬／年維護
使用人數不設限、多組織可獨立運作，雲端與 AI 用多少付多少
智慧財產版權歸公司所有`,
...
本平台以「支援專家判斷、降低行政與教學負擔」為核心設計原則，而非取代專業決策。`,
    ...
    value: {
      ...
      items: [
        {
          title: '10 年教育科技經驗，深諳核心資料結構（班／生／師／課）',
          detail: '兼具產品、設計、工程、資料科學視角，與現場教師深度協作，省去溝通成本、直接切入需求、快速落地',
        },
        {
        ...
        },
        {
          ...
          detail: '與校長、課程專家深度協作，從課綱架構、學習歷程到評量制度，完整主導教務數位系統設計與落地',
        },
        {
          title: 'TFT、KIST、中央縣市局處計畫案 多次教育數位合作經驗',
          detail: '理解現場痛點與高層 KPI，具備產品思維與計畫管理雙重視角，能在多層溝通中找到平衡',
        },
        {
